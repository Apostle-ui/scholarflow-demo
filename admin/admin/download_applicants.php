...
// Query to fetch all applicant data
$sql = "SELECT 
...
if ($result->num_rows > 0) {
    ...
    $sheet1->setCellValue('A1', 'All Applicants - Demographic'); // Add header
    ...
    $sheet2->setCellValue('A1', 'All Applicants - Parent Data'); // Add header
    ...
    $sheet3->setCellValue('A1', 'All Applicants - School Data'); // Add header
    ...
    header('Content-Disposition: attachment;filename="All Applicants.xlsx"');
