...
$sql = "SELECT * FROM half_scholar_applicant";
    ...
    if ($result) {
      ...
      echo "<script>
          window.onload = function() {
              Swal.fire({
                  icon: 'success',
                  title: 'All Half Scholar Applicants Removed',
                  text: 'All half scholarship applicants have been removed.',
      ...
      echo "<script>
          window.onload = function() {
              Swal.fire({
                  title: 'Error!',
                  text: 'No half scholarship applicants found.',
                  icon: 'error',
                  confirmButtonText: 'OK'
              }).then(() => {
                  window.location.href = 'halfscholar.php';
