...
// Query to fetch rejected applicant data
$sql = "SELECT 
...
if ($result->num_rows > 0) {
    ...
    $sheet1->setCellValue('A1', 'Rejected Applicants - Demographic'); // Add header
    ...
    $sheet2->setCellValue('A1', 'Rejected Applicants - Parent Data'); // Add header
    ...
    $sheet3->setCellValue('A1', 'Rejected Applicants - School Data'); // Add header
    ...
    header('Content-Disposition: attachment;filename="Rejected Applicants.xlsx"');
