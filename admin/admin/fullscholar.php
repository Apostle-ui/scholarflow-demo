...
$sql = "SELECT applicant_id, firstname, middlename, lastname, gender, birthdate FROM full_scholar_applicant";
...
<head>
    ...
    <title>Full Scholar Applicants</title>
...
<!-------------TO REMOVE THE FLASHY THING WHEN IN DARK MODE---------------->
    ...
    <section id="content">
		...
		<div class="head-title">
                <div class="left">
                    <h1>Full Scholar Applicants</h1>
                </div>

                <form id="downloadForm" method="POST" action="download_full_scholar.php">
                    <button type="submit" class="btn-download" onclick="return confirmDownloadFullScholar(event)">
                        <i class='bx bxs-download'></i>
                        <span class="text">Download All Full Scholar</span>  
                    </button>
                </form>

				<form id="removeForm" method="POST" action="remove_all_full_scholar.php">
                    <button type="submit" class="btn-download" onclick="return confirmRemoveAllFullScholar(event)">
                        <i class='bx bxs-trash'></i>
                        <span class="text">Remove All Full Scholar</span>  
                    </button>
                </form>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                            ...
                                            <td>
                                               ...
                                               <form action='remove_full_scholar.php' method='POST' style='display: inline;'>
